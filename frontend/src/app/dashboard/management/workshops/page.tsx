                ...
                <div className="overflow-x-auto overflow-y-hidden scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
                  <div className="flex gap-2 md:gap-4 px-4 md:px-6 min-w-max">
                    <button
                      ...
                      className={`py-3 px-3 md:px-4 border-b-2 font-medium text-sm whitespace-nowrap ${
                        detailsTab === 'info'
                    ...
                    <button
                      ...
                      className={`py-3 px-3 md:px-4 border-b-2 font-medium text-sm flex items-center gap-2 whitespace-nowrap ${
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                          <div className="text-sm text-gray-700 dark:text-gray-300">
                            <p>تعداد کل سفارشات: {performance.totalOrders}</p>
                            <p className="mt-1">تعداد تکمیل شده: {performance.completedOrders}</p>
                            <p className="mt-1">نرخ تکمیل: {performance.completionRate}%</p>
                          </div>
                        </div>
                        <div className="p-4 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                          <div className="text-sm text-gray-700 dark:text-gray-300">
                            <p>مجموع هزینه: {formatCurrency(performance.totalCost || 0)}</p>
                            <p className="mt-1">میانگین کیفیت: {performance.averageQualityRating ?? '-'}</p>
                            <p className="mt-1">امتیاز کارگاه: {performance.rating ?? '-'}</p>
                          </div>
                        </div>
                      </div>
                    )}
