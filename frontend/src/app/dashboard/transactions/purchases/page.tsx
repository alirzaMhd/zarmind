                  ...
                  {formData.items.map((it, idx) => (
                    <div key={idx} className="grid grid-cols-1 md:grid-cols-7 gap-2 items-end">
                      <div className="md:col-span-3">
                        <label className="text-xs text-gray-600 dark:text-gray-400">شناسه محصول (SKU/ID)</label>
                        <input
                          type="text"
                          value={it.productId}
                          onChange={(e) => {
                      ...
                      <div>
                        <label className="text-xs text-gray-600 dark:text-gray-400">تعداد</label>
                        <input
                          type="number"
                          value={it.quantity}
                          onChange={(e) => {
                      ...
                      <div>
                        <label className="text-xs text-gray-600 dark:text-gray-400">قیمت واحد</label>
                        <input
                          type="number"
                          step="0.01"
                          value={it.unitPrice}
                      ...
                      <div>
                        <label className="text-xs text-gray-600 dark:text-gray-400">وزن (اختیاری)</label>
                        <input
                          type="number"
                          step="0.001"
                          value={it.weight}
