...
async function main() {
  ...
  await prisma.notification.createMany({
    data: [
      ...
      {
        type: NotificationType.CHECK_DUE,
      ...
      },
      {
        ...
        roleTarget: UserRole.MANAGER,
        actionUrl: '/financials/receivables',
        actionLabel: 'View Receivables',
      },
      {
        type: NotificationType.WORK_ORDER_DUE,
        priority: NotificationPriority.MEDIUM,
      ...
      },
      {
        ...
        roleTarget: UserRole.SALES_STAFF,
  ...
  await prisma.document.createMany({
    data: [
      ...
      },
      {
        ...
        fileSize: 450000,
        mimeType: 'image/jpeg',
        type: DocumentType.EXPENSE_RECEIPT,
