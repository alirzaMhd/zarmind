...
const create_ar_dto_1 = require("./dto/create-ar.dto");
const update_ar_dto_1 = require("./dto/update-ar.dto");
...
let ArController = class ArController {
    ...
    findAll(page, limit, customerId, status, from, to, overdue, sortBy, sortOrder) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_ar_dto_1.CreateArDto]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_ar_dto_1.UpdateArDto]),
    __metadata("design:returntype", void 0)
], ArController.prototype, "update", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ArController.prototype, "remove", null);
exports.ArController = ArController = __decorate([
    ...
    (0, common_1.Controller)('financials/accounts-receivable'),
