...
exports.RawGoldController = void 0;
...
const create_raw_gold_dto_1 = require("./dto/create-raw-gold.dto");
const update_raw_gold_dto_1 = require("./dto/update-raw-gold.dto");
let RawGoldController = class RawGoldController {
    constructor(service) {
    ...
    findAll(page, limit, search, goldPurity, status, branchId, minWeight, maxWeight, minPrice, maxPrice, sortBy, sortOrder) {
...
exports.RawGoldController = RawGoldController;
__decorate([
    ...
    __metadata("design:paramtypes", [create_raw_gold_dto_1.CreateRawGoldDto]),
    __metadata("design:returntype", void 0)
], RawGoldController.prototype, "create", null);
__decorate([
    ...
    __param(6, (0, common_1.Query)('minWeight')),
    __param(7, (0, common_1.Query)('maxWeight')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, typeof (_a = typeof shared_types_1.GoldPurity !== "undefined" && shared_types_1.GoldPurity) === "function" ? _a : Object, typeof (_b = typeof shared_types_1.ProductStatus !== "undefined" && shared_types_1.ProductStatus) === "function" ? _b : Object, String, String, String, String, String, String, String]),
    __metadata("design:returntype", void 0)
], RawGoldController.prototype, "findAll", null);
__decorate([
    (0, roles_decorator_1.Roles)(shared_types_1.UserRole.MANAGER, shared_types_1.UserRole.ADMIN, shared_types_1.UserRole.SUPER_ADMIN, shared_types_1.UserRole.SALES_STAFF, shared_types_1.UserRole.WAREHOUSE_STAFF, shared_types_1.UserRole.ACCOUNTANT, shared_types_1.UserRole.VIEWER),
    ...
    __metadata("design:returntype", void 0)
], RawGoldController.prototype, "getSummary", null);
__decorate([
    (0, roles_decorator_1.Roles)(shared_types_1.UserRole.MANAGER, shared_types_1.UserRole.ADMIN, shared_types_1.UserRole.SUPER_ADMIN, shared_types_1.UserRole.SALES_STAFF, shared_types_1.UserRole.WAREHOUSE_STAFF, shared_types_1.UserRole.ACCOUNTANT, shared_types_1.UserRole.VIEWER),
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], RawGoldController.prototype, "getValuation", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], RawGoldController.prototype, "findOne", null);
__decorate([
    (0, roles_decorator_1.Roles)(shared_types_1.UserRole.MANAGER, shared_types_1.UserRole.ADMIN, shared_types_1.UserRole.SUPER_ADMIN, shared_types_1.UserRole.WAREHOUSE_STAFF),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_raw_gold_dto_1.UpdateRawGoldDto]),
    __metadata("design:returntype", void 0)
], RawGoldController.prototype, "update", null);
__decorate([
    (0, roles_decorator_1.Roles)(shared_types_1.UserRole.MANAGER, shared_types_1.UserRole.ADMIN, shared_types_1.UserRole.SUPER_ADMIN, shared_types_1.UserRole.WAREHOUSE_STAFF),
    (0, common_1.Patch)(':id/adjust-weight'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], RawGoldController.prototype, "adjustWeight", null);
__decorate([
    (0, roles_decorator_1.Roles)(shared_types_1.UserRole.MANAGER, shared_types_1.UserRole.ADMIN, shared_types_1.UserRole.SUPER_ADMIN, shared_types_1.UserRole.WAREHOUSE_STAFF),
    ...
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", void 0)
], RawGoldController.prototype, "transferToWorkshop", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], RawGoldController.prototype, "remove", null);
exports.RawGoldController = RawGoldController = __decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, common_1.Controller)('inventory/raw-gold'),
    __metadata("design:paramtypes", [raw_gold_service_1.RawGoldService])
], RawGoldController);
//# sourceMappingURL=raw-gold.controller.js.map