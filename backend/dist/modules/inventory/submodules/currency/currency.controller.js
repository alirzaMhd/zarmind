...
const record_currency_trade_dto_1 = require("./dto/record-currency-trade.dto");
let CurrencyController = class CurrencyController {
    ...
    findAll(page, limit, search, currencyCode, status, branchId, minQuantity, maxQuantity, sortBy, sortOrder) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, String, typeof (_a = typeof shared_types_1.ProductStatus !== "undefined" && shared_types_1.ProductStatus) === "function" ? _a : Object, String, String, String, String, String]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], CurrencyController.prototype, "getSummary", null);
__decorate([
    (0, roles_decorator_1.Roles)(shared_types_1.UserRole.MANAGER, shared_types_1.UserRole.ADMIN, shared_types_1.UserRole.SUPER_ADMIN, shared_types_1.UserRole.SALES_STAFF, shared_types_1.UserRole.WAREHOUSE_STAFF, shared_types_1.UserRole.VIEWER),
...
__decorate([
    ...
    (0, common_1.Post)(':id/trade'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, record_currency_trade_dto_1.RecordCurrencyTradeDto]),
    __metadata("design:returntype", void 0)
], CurrencyController.prototype, "recordTrade", null);
__decorate([
    (0, roles_decorator_1.Roles)(shared_types_1.UserRole.MANAGER, shared_types_1.UserRole.ADMIN, shared_types_1.UserRole.SUPER_ADMIN, shared_types_1.UserRole.WAREHOUSE_STAFF),
    ...
    __metadata("design:returntype", void 0)
], CurrencyController.prototype, "adjustQuantity", null);
__decorate([
...
exports.CurrencyController = CurrencyController = __decorate([
    ...
    (0, common_1.Controller)('inventory/currency'),
